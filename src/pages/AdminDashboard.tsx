    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Bienvenido, {user?.name || 'Admin'}. Gestiona tu plataforma desde aquí.
        </p>
      </div>
        ...
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-8">
            {[
              ...
              { key: 'users', label: '👥 Usuarios', count: stats.totalUsers },
              { key: 'sitters', label: '🐕 Cuidadores', count: stats.totalSitters },
              { key: 'approvals', label: '✅ Aprobaciones', count: stats.pendingApprovals }
            ].map(tab => (
              <button
                key={tab.key}
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.totalSitters}</p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-600">Ver y administrar todos los usuarios</p>
                    </div>
                  </div>
                </button>
                ...
                >
                  <div className="flex items-center">
                    <span className="text-2xl mr-3">🐕</span>
                    <div>
                      <p className="font-medium text-green-900">Gestionar Cuidadores</p>
                      <p className="text-sm text-green-600">Aprobar y administrar cuidadores</p>
                    </div>
                  </div>
                </button>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="flex justify-between items-center w-full">
                      <div>
                        <p className="font-medium text-yellow-900">Aprobaciones Pendientes</p>
                        <p className="text-sm text-yellow-600">Revisar solicitudes</p>
                      </div>
                ...
                <button className="w-full p-4 text-left bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors border border-purple-200">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-purple-600">Estadísticas y análisis</p>
                    </div>
                  </div>
                </button>
              </div>
                ...
                {recentActivity.length === 0 ? (
                  ...
                  recentActivity.map(activity => (
                    <div key={activity.id} className="flex items-start p-3 bg-gray-50 rounded-lg">
                      <span className="text-lg mr-3 mt-0.5">{getActivityIcon(activity.type)}</span>
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(activity.status)}`}>
                        ...
                        activity.status === 'pending' ? 'Pendiente' : 'Atención'}
                      </span>
                    </div>
                  ))
                )}
