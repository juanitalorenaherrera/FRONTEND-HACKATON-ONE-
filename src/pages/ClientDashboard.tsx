					...
					<div className="text-center py-16 bg-white rounded-2xl shadow-sm border border-gray-100">
						<div className="max-w-md mx-auto">
							...
							<p className="text-gray-600 mb-8 leading-relaxed">
								Tus cuidadores favoritos aparecerán aquí para
								acceso rápido
							</p>
							<button
								onClick={() =>
									handleNavigationAction('find-sitters')
								}
					...
					<div className="text-center py-16 bg-white rounded-2xl shadow-sm border border-gray-100">
						<div className="max-w-md mx-auto">
							<div className="w-20 h-20 bg-yellow-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
								...
								>
									<path
										...
										strokeLinejoin="round"
										strokeWidth={2}
										d="M15 17h5l-5 5v-5zM4 19l1-1h5.586L15 13.586l1-1H21V4a1 1 0 00-1-1H4a1 1 0 00-1 1v14z"
									/>
								</svg>
							</div>
							<h2 className="text-2xl font-bold text-gray-900 mb-4">
							...
							<p className="text-gray-600 leading-relaxed">
								Aquí verás todas tus notificaciones importantes
								sobre citas, recordatorios y actualizaciones
							</p>
						</div>
					</div>
				);
				...
				return (
					<div className="text-center py-16 bg-white rounded-2xl shadow-sm border border-gray-100">
						<div className="max-w-md mx-auto">
							...
							<p className="text-gray-600 leading-relaxed">
								Gestiona tus métodos de pago, historial de
								facturas y configuración de billing
							</p>
						</div>
					</div>
				);
				...
				return (
					<div className="text-center py-16 bg-white rounded-2xl shadow-sm border border-gray-100">
						<div className="max-w-md mx-auto">
							...
							<p className="text-gray-600 leading-relaxed">
								Edita tu información personal, foto de perfil y
				...
				return (
					<div className="text-center py-16 bg-white rounded-2xl shadow-sm border border-gray-100">
						<div className="max-w-md mx-auto">
							...
							<p className="text-gray-600 leading-relaxed">
								Personaliza notificaciones, privacidad y otras
