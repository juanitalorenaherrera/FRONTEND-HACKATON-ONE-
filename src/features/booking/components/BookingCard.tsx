...
import { Calendar, Clock, Dog, User } from 'lucide-react';

import { BOOKING_STATUS_CONFIG } from '../constants'; // Asumiendo que creas este archivo
  ...
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
      <div className="flex justify-between items-center mb-3">
        <h3 className="font-bold text-lg text-gray-800">{booking.serviceName || 'Cita de Cuidado'}</h3>
        <span
      ...
      <div className="space-y-3 text-sm text-gray-600">
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-gray-800">{booking.petName}</span>
        </div>
        <div className="flex items-center gap-2">
