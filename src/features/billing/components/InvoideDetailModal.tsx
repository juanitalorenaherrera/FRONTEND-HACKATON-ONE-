...
import { type InvoiceDetailModalProps } from '@/features/billing/types/invoices';
import React from 'react';
import { motion } from 'framer-motion';
import { getStatusColor } from '../utils/getStatusColor';
import { getStatusText } from '../utils/getStatusText';
import { formatDate } from '@/features/billing/utils/formDate';
...
export function InvoiceDetailModal({
	...
	if (!isOpen || !invoice) return <div>null</div>;
				...
				<div className="p-6 space-y-6">
					...
					<div className="border border-gray-200 rounded-xl p-4">
						...
						<div className="space-y-2 text-sm text-gray-600">
							<p>
								• Esta factura incluye todos los servicios
								utilizados durante el período de facturación.
							</p>
							<p>
								• Para consultas sobre esta factura, contacta
								con nuestro equipo de soporte.
							</p>
							{isPending(invoice) && (
								<p className="text-orange-600 font-medium">
									• Esta factura está pendiente de pago.
									Puedes pagarla ahora o descargar el PDF para
									mayor detalle.
								</p>
							)}
						</div>
