...
import { type PaymentMethodCardProps } from '../types/invoices';
import { getCardBrandIconView } from '../view/getBrandIconView';
import { getCardGradient } from '../utils/getBrandGradient';
		...
		>
			...
			<div
				className={`${getCardGradient(
					method.brand
				)} text-white p-6 relative min-h-[160px]`}
			>
				{/* Background Pattern */}
				...
				<div className="relative z-10">
					...
					<div className="flex justify-between items-start mb-6">
						<div className="text-white/80">
							{getCardBrandIconView(method.brand)}
						</div>
