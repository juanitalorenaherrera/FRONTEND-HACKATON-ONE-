...
import { PawPrint, Dog, Cat, Syringe, Pill, Weight, Palette } from 'lucide-react';
...
const petSchema = z.object({
  ...
  weight: z.number().min(0, "El peso debe ser un número positivo.").optional(),
...
const FormInput: FC<FormInputProps & { register: any }> = ({ 
  icon, 
  name, 
  label, 
  register, 
    ...
    <div className="relative group">
      ...
      <input
        ...
        className={`w-full pl-12 pr-4 py-3 bg-white border-2 rounded-xl focus:outline-none focus:ring-4 focus:ring-pet-orange/20 transition-all duration-200 text-gray-900 placeholder-gray-400 ${
          error ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-pet-orange'
        }`}
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2 text-lg">
            Completa la información para cuidar mejor de tu compañero.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="bg-white/70 backdrop-blur-lg p-6 sm:p-8 rounded-2xl shadow-lg border border-white/20">
            <h2 className="text-xl font-bold text-gray-800 mb-6">Historial de Salud (Opcional)</h2>
            <div className="space-y-6">
              ...
              />
              <div>
                <label htmlFor="specialNotes" className="block text-sm font-semibold text-gray-700 mb-1">
                  Notas Especiales
                </label>
                <textarea
                  id="specialNotes"
